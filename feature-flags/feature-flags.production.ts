...
export const flagsProduction: FeatureFlagsInterface = {
  ...
  FEATURE_ENDGAME_NAVIGATION_SECTION: false,
  FEATURE_ENDGAME_BUDGET_STRUCTURE_SECTION: false,
  FEATURE_ENDGAME_BUDGET_TRANSITION_SECTION: false,
  FEATURE_FINANCES_ENDGAME_BANNER_SECTION: false,
  ...
  FEATURE_ENDGAME_MILESTONES_PHASE_1: false,
