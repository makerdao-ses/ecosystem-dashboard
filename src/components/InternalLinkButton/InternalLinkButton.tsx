...
const ContainerLink = styled(Link)<{ background?: string; buttonType?: string }>(
  ({ theme, buttonType = 'primary' }) => ({
    ...
    '& path': {
      fill: theme.palette.isLight ? theme.palette.colors.charcoal[600] : theme.palette.colors.charcoal[300],
    },
    ':hover': {
      gap: 16,
