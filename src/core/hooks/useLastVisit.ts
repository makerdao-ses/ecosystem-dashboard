...
export const useLastVisit = (collection: string, shouldUpdate = true): LastVisitResult => {
  ...
  }, [isTimestampTrackingAccepted, permissionManager, shouldUpdate, collection, authToken, activityHistory]);

  useEffect(() => {
    forceVisit();
  }, [collection, permissionManager, isTimestampTrackingAccepted, forceVisit]);
