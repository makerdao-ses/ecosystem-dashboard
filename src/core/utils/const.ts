...
export const COOKIES_POLICY_PARAGRAPH_ONE =
...
export const COOKIES_POLICY_PARAGRAPH_TWO =
...
export const COOKIES_POLICY_PARAGRAPH_THREE =
...
export const INVALID_CHARACTERS_MESSAGE = 'Your password contains an invalid characters or white space';
