...
const args = [
  {
    ...
    isDisabled: true,
    series: builderWaterFallSeries(data, true, false, true, 'monthly'),
  },
  {
    selectedGranularity: 'monthly',
    title: 'MakerDAO Finances Reserves',
    ...
    year: '2023',
    series: builderWaterFallSeries(data, false, true, true, 'monthly'),
    activeItems: [],
    handleSelectChangeItem: () => null,
    handleGranularityChange: () => null,
    handleResetFilter: () => null,
  ...
  },
  {
    ...
    year: '2023',
    series: builderWaterFallSeries(data, false, false, true, 'monthly'),
    activeItems: [],
    handleSelectChangeItem: () => null,
    handleGranularityChange: () => null,
    handleResetFilter: () => null,
