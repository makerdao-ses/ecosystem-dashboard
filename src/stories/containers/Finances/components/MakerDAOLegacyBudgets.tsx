...
const MakerDAOLegacyBudgets: React.FC<Props> = ({ height = 64, width = 64, ...props }) => (
  <svg width={width} height={height} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M27.398 51.5h9V59a1.5 1.5 0 01-1.5 1.5h-6a1.5 1.5 0 01-1.5-1.5v-7.5z" fill="#546978" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
