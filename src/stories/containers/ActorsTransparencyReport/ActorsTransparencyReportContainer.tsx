...
import ExpenseReport from '@/views/TransparencyReport/components/ExpenseReport/ExpenseReport';
import { TransparencyActuals } from '@/views/TransparencyReport/components/TransparencyActuals/TransparencyActuals';
import { TransparencyAudit } from '@/views/TransparencyReport/components/TransparencyAudit/TransparencyAudit';
import AuditorCommentsContainer from '@/views/TransparencyReport/components/TransparencyAuditorComments/AuditorCommentsContainer/AuditorCommentsContainer';
import { TransparencyForecast } from '@/views/TransparencyReport/components/TransparencyForecast/TransparencyForecast';
import { TransparencyMkrVesting } from '@/views/TransparencyReport/components/TransparencyMkrVesting/TransparencyMkrVesting';
import { TransparencyTransferRequest } from '@/views/TransparencyReport/components/TransparencyTransferRequest/TransparencyTransferRequest';
