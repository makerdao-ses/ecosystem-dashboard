...
export const initialState = {
  items: [
      ...
      .addBudgetStatement(
        new BudgetStatementBuilder()
          ...
          .addBudgetStatementWallet(
            new BudgetStatementWalletBuilder().withLineItems([1200, 100, 400], CURRENT_MINUS_1_MONTH).build()
          )
          .addBudgetStatementFTE(new BudgetStatementFteBuilder().withMonth(CURRENT_MINUS_1_MONTH).withFtes(3.5).build())
          .build()
      )
      .addBudgetStatement(
        new BudgetStatementBuilder()
          ...
          .addBudgetStatementWallet(
            new BudgetStatementWalletBuilder().withLineItems([900, 100, 100], CURRENT_MINUS_2_MONTH).build()
          )
          .build()
      )
      .addBudgetStatement(
        new BudgetStatementBuilder()
          ...
          .addBudgetStatementWallet(
            new BudgetStatementWalletBuilder().withLineItems([200, 300, 100], CURRENT_MINUS_3_MONTH).build()
          )
          .build()
      )
    ...
    new CoreUnitsBuilder()
      ...
      .addBudgetStatement(
        new BudgetStatementBuilder()
          .withMonth(CURRENT_MINUS_1_MONTH)
          .addBudgetStatementWallet(
            new BudgetStatementWalletBuilder().withLineItems([200, 100, 400], CURRENT_MINUS_1_MONTH).build()
          )
          .addBudgetStatementFTE(new BudgetStatementFteBuilder().withMonth(CURRENT_MINUS_1_MONTH).withFtes(2.5).build())
          .build()
      )
      .addBudgetStatement(
        new BudgetStatementBuilder()
          .withMonth(CURRENT_MINUS_2_MONTH)
          .addBudgetStatementWallet(
            new BudgetStatementWalletBuilder().withLineItems([1000, 100, 100], CURRENT_MINUS_2_MONTH).build()
          )
          .build()
      )
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('2').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('2').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('2').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addSocialMediaChannel({
        forumTag: 'some-tag',
    ...
    new CoreUnitsBuilder()
      ...
      .addBudgetStatement(
        new BudgetStatementBuilder()
          .withMonth(CURRENT_MINUS_1_MONTH)
          .addBudgetStatementWallet(
            new BudgetStatementWalletBuilder().withLineItems([500, 100, 400], CURRENT_MINUS_1_MONTH).build()
          )
          .addBudgetStatementFTE(new BudgetStatementFteBuilder().withMonth(CURRENT_MINUS_1_MONTH).withFtes(7.5).build())
          .build()
      )
      .addBudgetStatement(
        new BudgetStatementBuilder()
          .withMonth(CURRENT_MINUS_3_MONTH)
          .addBudgetStatementWallet(
            new BudgetStatementWalletBuilder().withLineItems([100, 100, 100], CURRENT_MINUS_3_MONTH).build()
          )
          .build()
      )
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('3').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addSocialMediaChannel({
        forumTag: 'some-tag',
        linkedIn: 'https://linkedin.com',
        youtube: '',
    ...
    new CoreUnitsBuilder()
      ...
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('4').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('4').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('4').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('4').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addSocialMediaChannel({
    ...
    new CoreUnitsBuilder()
      ...
      .addBudgetStatement(
        new BudgetStatementBuilder()
          .withMonth(CURRENT_MINUS_2_MONTH)
          .addBudgetStatementWallet(
            new BudgetStatementWalletBuilder().withLineItems([400, 100, 400], CURRENT_MINUS_2_MONTH).build()
          )
          .addBudgetStatementFTE(new BudgetStatementFteBuilder().withMonth(CURRENT_MINUS_1_MONTH).withFtes(10).build())
          .build()
      )
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('5').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('5').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addSocialMediaChannel({
        forumTag: '',
        linkedIn: 'https://linkedin.com',
    ...
    new CoreUnitsBuilder()
      ...
      .addBudgetStatement(
        new BudgetStatementBuilder()
          .withMonth(CURRENT_MINUS_3_MONTH)
          .addBudgetStatementWallet(
            new BudgetStatementWalletBuilder().withLineItems([200, 100, 400], CURRENT_MINUS_3_MONTH).build()
          )
          .addBudgetStatementFTE(new BudgetStatementFteBuilder().withMonth(CURRENT_MINUS_1_MONTH).withFtes(4.5).build())
          .build()
      )
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('6').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addSocialMediaChannel({
        forumTag: 'some-tag',
        linkedIn: 'https://linkedin.com',
        youtube: 'https://youtube.com',
    ...
    new CoreUnitsBuilder()
      ...
      .withCode('CU7')
      .addCategory(CuCategoryEnum.Business)
      .addRoadMap(new RoadmapBuilder().withOwnerCuId('7').withRoadmapStatus(RoadmapStatusEnum.InProgress).build())
      .addSocialMediaChannel({
        forumTag: 'some-tag',
        linkedIn: 'https://linkedin.com',
        youtube: 'https://youtube.com',
