...
const StyleLevelExpenditure = styled(Typography, { shouldForwardProp: (prop) => prop !== 'isLight' && prop !== 'levelExpenditure' })<{ levelExpenditure: ExpenditureLevel, isLight?: boolean }>(({ levelExpenditure, isLight }) => ({
