...
import SESTooltipLegacy from './SESTooltipLegacy';
...
const meta: Meta<typeof SESTooltipLegacy> = {
  title: 'Components/General/SESTooltipLegacy',
  component: SESTooltipLegacy,
...
const getCustomBtnTemplate: (btnText?: string) => ComponentStory<typeof SESTooltipLegacy> =
  ...
  ({ ...args }) =>
    (
      <WideContainer>
        <SESTooltipLegacy {...args} content={<>Custom content here.</>}>
          <button>{btnText}</button>
        </SESTooltipLegacy>
      </WideContainer>
    );

const VariablePlacementTemplate: ComponentStory<typeof SESTooltipLegacy> = ({ placement, ...args }) => (
  <CenteredContent>
    <SESTooltipLegacy
      placement={placement}
      {...args}
...
const BoundariesTemplate: ComponentStory<typeof SESTooltipLegacy> = ({ placement, ...args }) => (
  <OverflownContainer
...
const CustomStyledTemplate: ComponentStory<typeof SESTooltipLegacy> = ({ placement, ...args }) => (
  <CenteredContent>
    <StyledTooltip
      placement={placement}
      {...args}
...
const StyledTooltip = styled(SESTooltipLegacy)(() => ({
  backgroundColor: 'red',
  color: 'white',
