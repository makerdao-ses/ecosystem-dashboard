...
const CheckboxOn = ({ height = 16, width = 16 }: Props) => {
  return <svg width={width} height={height} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M0 3C0 1.34315 1.34315 0 3 0H13C14.6569 0 16 1.34315 16 3V13C16 14.6569 14.6569 16 13 16H3C1.34315 16 0 14.6569 0 13V3Z" fill="#B6EDE7"/>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
