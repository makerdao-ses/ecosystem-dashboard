...
import CoreUnitBudgetStatementView from './CoreUnitBudgetStatementView';
import type { Meta } from '@storybook/react';

const meta: Meta<typeof CoreUnitBudgetStatementView> = {
  title: 'Fusion/Pages/Core Unit Budget Statement',
  component: CoreUnitBudgetStatementView,
...
const [
  ...
  (props) => (
    <FeatureFlagsProvider enabledFeatures={featureFlags[CURRENT_ENVIRONMENT]}>
      <AppLayout>
        <CoreUnitBudgetStatementView {...props} />
      </AppLayout>
