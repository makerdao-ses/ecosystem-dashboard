...
const useTeamView = (teamTypes: Team[]) => {
  const getTeamsNumber = (teams: Team[], resource: ResourceType) =>
    teams.filter((team) => team.type === resource).length;
  ...
  const currentTeams = [
    {
      ...
      teams: getTeamsNumber(teamTypes, ResourceType.EcosystemActor),
    ...
    },
    {
      ...
      teams: getTeamsNumber(teamTypes, ResourceType.AlignedDelegates),
    ...
    },
    {
      ...
      teams: getTeamsNumber(teamTypes, ResourceType.Keepers),
  ...
  const legacyTeams = [
    {
      ...
      teams: getTeamsNumber(teamTypes, ResourceType.CoreUnit),
    ...
    },
    {
      ...
      teams: getTeamsNumber(teamTypes, ResourceType.Delegates),
    ...
    },
    {
      ...
      teams: getTeamsNumber(teamTypes, ResourceType.Scopes),
